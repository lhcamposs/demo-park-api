...
import com.lhcampos.demo_park_api.jwt.JwtUserDetailsService;
...
public class AutenticacaoController {
    ...
    @Operation(summary = "Autenticar na API", description = "Recurso de autenticação na API",
            responses = {
                    @ApiResponse(responseCode = "201", description = "Autenticação realizada com sucesso e retorno de bearer token",
