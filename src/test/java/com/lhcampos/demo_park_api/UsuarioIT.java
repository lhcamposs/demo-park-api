...
import com.lhcampos.demo_park_api.web.dto.UsuarioCreateDto;
import com.lhcampos.demo_park_api.web.dto.UsuarioResponseDto;
import com.lhcampos.demo_park_api.web.dto.UsuarioSenhaDto;
...
public class UsuarioIT {
    ...
    public void createUsuario_ComPasswordInvalido_RetornaErrorMessageStatus422() {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("toddy@email.com", "123"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void createUsuario_ComUsernameRepetidos_RetornaErrorMessageStatus409() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void buscarUsuario_ComIdInexistente_RetornaUsuarioComStatus404() {
        ErrorMessage responseBody = testClient
                .get()
    ...
    @Test
    public void buscarUsuario_ComUsuarioClienteBuscandoOutroCliente_RetornaErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
    ...
    @Test
    public void editarSenha_ComUsuariosDiferentes_RetornaErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/0")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
    ...
    @Test
    public void editarSenha_ComSenhaInvalidas_RetornaErrorMessageComStatus400() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
