...
public class EstacionamentoIT {
    ...
    public void criarCheckin_ComDadosValidos_RetornarCreatedAndLocation() {
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                ...
                .cor("AZUL").clienteCpf("66448441034")
                .build();
        ...
        testClient.post().uri("/api/v1/estacionamentos/check-in")
                ...
                .jsonPath("clienteCpf").isEqualTo("66448441034")
    ...
    public void criarCheckin_ComCpfInexistente_RetornarErrorStatus404() {
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0")
                .cor("AZUL").clienteCpf("98699850093")
                .build();
    ...
    public void buscarCheckin_ComPerfilAdmin_RetornarDadosStatus200() {
        ...
        testClient.get()
                ...
                .jsonPath("clienteCpf").isEqualTo("34304891057")
    ...
    public void buscarEstacionamentos_PorClienteCpf_RetornarSucessoStatus200() {
        ...
        PageableDto responseBody = testClient.get()
                .uri("/api/v1/estacionamentos/cpf/{cpf}?size=1&page=0", "34304891057")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
        ...
        responseBody = testClient.get()
                .uri("/api/v1/estacionamentos/cpf/{cpf}?size=1&page=1", "34304891057")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(PageableDto.class)
    ...
    public void buscarEstacionamentos_PorClienteCpfComPerfilCliente_RetornarErrorStatus403() {
        ...
        testClient.get()
                .uri("/api/v1/estacionamentos/cpf/{cpf}", "34304891057")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
                .jsonPath("status").isEqualTo("403")
                .jsonPath("path").isEqualTo("/api/v1/estacionamentos/cpf/34304891057")
                .jsonPath("method").isEqualTo("GET");
    }
